      ...
      try {
        ...
        //logic for removing blacklisted devices
          ...
          try {
            ...
            this.log.error('[1] The controllerLogicType does not exist in accessoryType list. controllerLogicType=', accessory.context.device?.lightParameters?.controllerLogicType);
            continue;
          }
