...
// import { temperatureToCCT, clamp, HSVtoRGB, RGBtoHSV, CCTtoTemperature } from './misc/utils';
// import { DEFAULT_ACCESSORY_COMMAND, DEFAULT_ACCESSORY_STATE, IAccessoryCommand, IAccessoryState, IConfigOptions, MagicHomeAccessory } from './misc/types';
...
// import { BaseController, ICommandOptions, IDeviceCommand, IDeviceState, IProtoDevice, IAnimationLoop, ICompleteResponse, mergeDeep, overwriteDeep, COMMAND_TYPE, AnimationController, colorWave } from 'magichome-platform';
...
//     protected activeControllerList: BaseController[];
...
//         this.accessoryState.whiteBrightness = value as number;
...
//     getHue() {
//         const { isOn, HSV: { hue, saturation } } = this.accessoryState;
...
//     getBrightness() {
//         const { isOn, HSV: { hue, saturation }, whiteBrightness: brightness } = this.accessoryState;
...
//     protected async sendCommand(accessoryCommand: IAccessoryCommand, commandOptions: ICommandOptions) {
...
//         const { isOn, HSV, } = accessoryCommand;
...
//         const { HSV: { hue, saturation, value }, colorTemperature, whiteBrightness: brightness, isOn } = this.deviceStateToAccessoryState(deviceState);
...
//                     break;
//                 case 2:
//                     accessoryState = { HSV: { hue, saturation, value }, isOn, whiteBrightness: brightness };
//                     break;
//                 case 3:
//                     accessoryState = { HSV: { hue, saturation, value }, isOn, whiteBrightness: brightness, colorTemperature };
//                     break;
//             }
...
//         const accessoryState: IAccessoryState = { HSV: { hue, saturation, value }, isOn, colorTemperature: 140, whiteBrightness: brightness };
//         return accessoryState;
//     }

//     initializeCharacteristics() {

//         const cachedDeviceInformation = this.accessoryState;
...
// // import type { API, CharacteristicEventTypes, CharacteristicValue, HAP, Service } from "homebridge";
// // import { AnimationController, BaseController } from "magichome-platform";
// // import { Logs } from "./logs";
// // import { AnimationAccessory, DefaultAccessoryCommand, IAccessoryCommand, IAccessoryState } from "./misc/types";
// // import { HomebridgeMagichomeDynamicPlatformAccessory } from "./platformAccessory";
...
// //         logs: Logs,
// //         api: API,
// //         accessory: AnimationAccessory,
// //         // accessoriesList: HomebridgeMagichomeDynamicPlatformAccessory[]

// //     ) {
// //         this.accessory = accessory;
// //         const animationController: AnimationController = new AnimationController([]);
...
// //         const name: string = value.toString();
// //         this.logs.warn('Renaming device to %o', name);
// //         this.accessory.context.animationLoop.name = name;
// //         this.api.updatePlatformAccessories([this.accessory]);
// //     }


// //     getHue() {
// //         const { isOn, HSV: { hue, saturation }, brightness } = this.accessoryState;
