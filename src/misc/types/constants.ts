...
import { AccessoryTypes, type HomebridgeAccessory, type IAccessoryCommand, type IAccessoryContext, type IAccessoryState } from "./types";
...
export const EXPECTED_CONTEXT_STRUCTURE: IAccessoryContext = {
  displayName: "Error",
  deviceMetaData: {
    rawData: null,
